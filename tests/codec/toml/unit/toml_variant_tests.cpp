...
ZEST_SUITE(codec_toml_variant_untagged) {
...
ZEST_SUITE(codec_toml_variant_internally_tagged) {
...
ZEST_SUITE(codec_toml_variant_externally_tagged) {
...
ZEST_SUITE(codec_toml_variant_adjacently_tagged) {
