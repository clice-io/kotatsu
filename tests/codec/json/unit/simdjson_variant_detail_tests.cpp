...
ZEST_SUITE(codec_json_simdjson_variant_detail_untagged) {
...
ZEST_SUITE(codec_json_simdjson_variant_detail_ext) {
...
ZEST_SUITE(codec_json_simdjson_variant_detail_adj) {
...
ZEST_SUITE(codec_json_simdjson_variant_detail_int_tag) {
...
ZEST_SUITE(codec_json_simdjson_variant_detail_nested) {
...
ZEST_SUITE(codec_json_simdjson_variant_detail_deep_dispatch) {
