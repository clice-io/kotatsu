...
ZEST_SUITE(serde_simdjson_config){
    ...
    ZEST_CASE(default_identity_rename){protocol_payload input{
        .request_id = 7,
        .user_name = "alice",
...
auto status =
    from_string(R"({"request_id":7,"user_name":"alice","nested_info":{"some_value":3}})", parsed);
