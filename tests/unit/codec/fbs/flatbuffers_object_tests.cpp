...
ZEST_SUITE(serde_flatbuffers_object) {
    ...
    struct with_deduced_base_enum {
        ...
        friend bool operator==(const with_deduced_base_enum&,
                               const with_deduced_base_enum&) = default;
    };
    ...
    struct over_limit_key {
        std::int32_t f00, f01, f02, f03, f04, f05, f06, f07, f08, f09, f10, f11, f12, f13, f14, f15,
            ...
            f50, f51, f52, f53, f54, f55, f56, f57, f58, f59, f60, f61, f62, f63, f64, f65, f66,
    ...
    ZEST_CASE(inline_struct_padding_never_reaches_the_buffer) {
        ...
        ASSERT(noisy_bytes.has_value());
        ASSERT(quiet_bytes.has_value());
        ...
        const auto* entries = root->GetPointer<
            const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::Table>>*>(8);
    ...
    ZEST_CASE(struct_keyed_map_empty_and_single_entry) {
        ...
        ASSERT(encoded_empty.has_value());
