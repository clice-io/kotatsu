...
KOTA_ALWAYS_INLINE error fs_stat(uv_loop_t& loop,
                                 uv_fs_t& req,
                                 const char* path,
                                 uv_fs_cb cb) noexcept {
...
KOTA_ALWAYS_INLINE error fs_readdir(uv_loop_t& loop,
                                    uv_fs_t& req,
                                    uv_dir_t& dir,
                                    uv_fs_cb cb) noexcept {
...
KOTA_ALWAYS_INLINE error fs_fstat(uv_loop_t& loop,
                                  uv_fs_t& req,
                                  uv_file file,
                                  uv_fs_cb cb) noexcept {
...
KOTA_ALWAYS_INLINE error fs_fsync(uv_loop_t& loop,
                                  uv_fs_t& req,
                                  uv_file file,
                                  uv_fs_cb cb) noexcept {
...
KOTA_ALWAYS_INLINE error fs_close(uv_loop_t& loop,
                                  uv_fs_t& req,
                                  uv_file file,
                                  uv_fs_cb cb) noexcept {
